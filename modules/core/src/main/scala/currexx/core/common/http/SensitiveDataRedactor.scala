...
final class SensitiveDataRedactor[F[_]](
  ...
  private[http] def redact(msg: String): String = regex.replaceAllIn(msg, """"$1":"***"""")
...
object SensitiveDataRedactor:
  def apply[F[_]: Sync](sensitiveFields: Set[String]): SensitiveDataRedactor[F] =
    ...
    new SensitiveDataRedactor[F](sensitiveFields, logger)
