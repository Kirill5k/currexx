      ...
      openRules = List(
        Rule(
          ...
          conditions = Rule.Condition.allOf(
            ...
            Rule.Condition.VelocityCrossedLevel(level = 0.0008, direction = Direction.Upward)
          )
        ),
        Rule(
          action = TradeAction.OpenShort,
          conditions = Rule.Condition.allOf(
            ...
            Rule.Condition.VelocityCrossedLevel(level = -0.0008, direction = Direction.Downward)
          )
        )
      ),
      closeRules = List(
