...
object TestStrategy {
  ...
  // GA-optimized indicator params for s6 (rules unchanged). Champion from ga-optimisation-2026-09-05-1615-s6.md (training 0.836878 -> validation 0.176923, retaining 21.1%).
  // BREACHES 2 constraint(s) on validation data:
  //   - profitable pair-months is 0.500, required >= 0.550
  //   - most concentrated pair's best month is 1.000, required <= 0.738 (0.700 scaled to 5 periods)
  // searched 2023-07..2025-07: net=5952.16444, closed=814, forced=5, win=70.27%, exp=7.312241, PF=1.752, DD=0.48%, Sharpe=3.500
  // holdout 2025-12..2026-06:  net=335.80694, closed=218, forced=2, win=63.76%, exp=1.540399, PF=1.114, DD=1.69%, Sharpe=0.539
  val s6_optimized = TestStrategy(
    indicator = Indicator.compositeAnyOf(
      Indicator.TrendChangeDetection(
        source = ValueSource.HLC3,
        transformation = ValueTransformation.JMA(length = 96, phase = 2, power = 1)
      ),
      Indicator.BollingerBands(
        source = ValueSource.Close,
        middleBand = ValueTransformation.SMA(length = 33),
  ...
  // GA-optimized indicator params for s6 (rules unchanged). Training fitness leader from ga-optimisation-2026-09-05-1615-s6.md (training 1.065207 -> validation 0.000000, retaining 0.0%).
  // BREACHES 2 constraint(s) on validation data:
  //   - profitable pair-months is 0.500, required >= 0.550
  //   - most concentrated pair's best month is 1.000, required <= 0.738 (0.700 scaled to 5 periods)
  // searched 2023-07..2025-07: net=5819.52608, closed=797, forced=5, win=70.14%, exp=7.301789, PF=1.737, DD=0.42%, Sharpe=3.770
  // holdout 2025-12..2026-06:  net=255.20884, closed=216, forced=2, win=63.89%, exp=1.181522, PF=1.085, DD=1.94%, Sharpe=0.370
  val s6_optimized_v2 = TestStrategy(
    indicator = Indicator.compositeAnyOf(
      Indicator.TrendChangeDetection(
        source = ValueSource.HLC3,
        transformation = ValueTransformation.JMA(length = 96, phase = -6, power = 1)
      ),
      Indicator.BollingerBands(
        source = ValueSource.Close,
  ...
  // GA-optimized indicator params for s6 (rules unchanged). Champion from ga-optimisation-2026-09-05-1806-s6_shuffle.md (training 0.677085 -> validation 0.048322, retaining 7.1%), shuffled GA.
  ...
  // searched 2023-07..2025-07: net=4336.81553, closed=859, forced=5, win=67.40%, exp=5.048679, PF=1.576, DD=0.49%, Sharpe=3.144
  // holdout 2025-12..2026-06:  net=145.50289, closed=231, forced=2, win=63.20%, exp=0.629883, PF=1.054, DD=1.77%, Sharpe=0.222
  val s6_optimized_v3 = TestStrategy(
    indicator = Indicator.compositeAnyOf(
      Indicator.TrendChangeDetection(
        source = ValueSource.HLC3,
        transformation = ValueTransformation.JMA(length = 96, phase = -14, power = 1)
      ),
      Indicator.BollingerBands(
        source = ValueSource.Close,
  ...
  // GA-optimized indicator params for s2_optimized_v3 (rules unchanged). Champion from ga-optimisation-2026-09-05-1950-s2_optimized_v3.md (training 0.644594 -> validation 0.069465, retaining 10.8%).
  // BREACHES 5 constraint(s) on validation data:
  //   - profitable pair-months is 0.500, required >= 0.550
  //   - most concentrated pair's best month is 1.000, required <= 0.738 (0.700 scaled to 5 periods)
  //   - pair-month profit factor is 1.285575787557514177538772976589571, required >= 1.3
  //   - profit factor is 1.09379, required >= 1.2
  //   - costs as a share of gross profit is 0.436, required <= 0.400
  // searched 2023-07..2025-07: net=8200.80899, closed=1678, forced=12, win=41.12%, exp=4.887252, PF=1.330, DD=0.85%, Sharpe=2.519
  // holdout 2025-12..2026-06:  net=2277.34659, closed=538, forced=5, win=40.52%, exp=4.232986, PF=1.302, DD=1.69%, Sharpe=3.000
  val s2_optimized_v5 = TestStrategy(
    indicator = Indicator.compositeAnyOf(
      Indicator.LinesCrossing(
        source = ValueSource.HLC3,
        line1Transformation = ValueTransformation.JMA(length = 19, phase = 4, power = 2),
        line2Transformation = ValueTransformation.JMA(length = 34, phase = -28, power = 2)
      ),
      Indicator.ThresholdCrossing(
        source = ValueSource.Close,
        transformation = ValueTransformation.RSX(length = 29),
      ...
      Indicator.VolatilityRegimeDetection(
        atrLength = 36,
        smoothingType = ValueTransformation.SMA(length = 41)
      )
    ),
    rules = TradeStrategy(
      openRules = List(
  ...
  // GA-optimized indicator params for s2_optimized_v3 (rules unchanged). Training fitness leader from ga-optimisation-2026-09-05-1950-s2_optimized_v3.md (training 1.068187 -> validation 0.000000, retaining 0.0%).
  // BREACHES 5 constraint(s) on validation data:
  //   - profitable pair-months is 0.500, required >= 0.550
  //   - most concentrated pair's best month is 1.000, required <= 0.738 (0.700 scaled to 5 periods)
  //   - pair-month profit factor is 1.285575787557514177538772976589571, required >= 1.3
  //   - profit factor is 1.09379, required >= 1.2
  //   - costs as a share of gross profit is 0.436, required <= 0.400
  // searched 2023-07..2025-07: net=9937.51217, closed=2002, forced=11, win=41.86%, exp=4.963792, PF=1.387, DD=0.72%, Sharpe=2.963
  // holdout 2025-12..2026-06:  net=1841.88868, closed=594, forced=6, win=39.39%, exp=3.100823, PF=1.231, DD=1.79%, Sharpe=1.794
  val s2_optimized_v6 = TestStrategy(
    indicator = Indicator.compositeAnyOf(
      Indicator.LinesCrossing(
        source = ValueSource.HLC3,
        line1Transformation = ValueTransformation.JMA(length = 19, phase = 7, power = 2),
        line2Transformation = ValueTransformation.JMA(length = 25, phase = -23, power = 2)
      ),
      Indicator.ThresholdCrossing(
        source = ValueSource.Close,
        transformation = ValueTransformation.RSX(length = 29),
  ...
  // GA-optimized indicator params for s2_optimized_v3 (rules unchanged). Champion from ga-optimisation-2026-09-05-2037-s2_optimized_v3_shuffle.md (training 1.080327 -> validation 0.006450, retaining 0.6%), shuffled GA.
  ...
  //   - profitable datasets is 0.500, required >= 0.667
  // searched 2023-07..2025-07: net=10469.19090, closed=1739, forced=12, win=39.91%, exp=6.020236, PF=1.446, DD=0.87%, Sharpe=3.280
  // holdout 2025-12..2026-06:  net=2470.75764, closed=511, forced=6, win=38.94%, exp=4.835142, PF=1.340, DD=1.22%, Sharpe=3.073
  val s2_optimized_v7 = TestStrategy(
    indicator = Indicator.compositeAnyOf(
      Indicator.LinesCrossing(
        source = ValueSource.HLC3,
        line1Transformation = ValueTransformation.JMA(length = 14, phase = 85, power = 2),
  ...
  // GA-optimized indicator params for s2_optimized_v4 (rules unchanged). Champion from ga-optimisation-2026-09-05-2126-s2_optimized_v4.md (training 0.676072 -> validation 0.181528, retaining 26.9%).
  // BREACHES 3 constraint(s) on validation data:
  //   - profitable pair-months is 0.467, required >= 0.550
  //   - most concentrated pair's best month is 0.818, required <= 0.738 (0.700 scaled to 5 periods)
  //   - profit factor is 1.13033, required >= 1.2
  // searched 2023-07..2025-07: net=8834.96141, closed=1597, forced=12, win=39.95%, exp=5.532224, PF=1.384, DD=0.97%, Sharpe=2.941
  // holdout 2025-12..2026-06:  net=1059.82527, closed=459, forced=6, win=39.65%, exp=2.308988, PF=1.138, DD=2.87%, Sharpe=0.995
  val s2_optimized_v9 = TestStrategy(
    indicator = Indicator.compositeAnyOf(
      Indicator.LinesCrossing(
        source = ValueSource.HLC3,
        line1Transformation = ValueTransformation.JMA(length = 14, phase = 9, power = 2),
        line2Transformation = ValueTransformation.JMA(length = 24, phase = -5, power = 1)
      ),
      Indicator.ThresholdCrossing(
        source = ValueSource.Close,
        transformation = ValueTransformation.RSX(length = 29),
  ...
  // GA-optimized indicator params for s2_optimized_v4 (rules unchanged). Training fitness leader from ga-optimisation-2026-09-05-2126-s2_optimized_v4.md (training 0.976652 -> validation 0.020317, retaining 2.1%).
  // BREACHES 3 constraint(s) on validation data:
  //   - profitable pair-months is 0.467, required >= 0.550
  //   - most concentrated pair's best month is 0.818, required <= 0.738 (0.700 scaled to 5 periods)
  //   - profit factor is 1.13033, required >= 1.2
  // searched 2023-07..2025-07: net=10849.68878, closed=1677, forced=12, win=40.25%, exp=6.469701, PF=1.472, DD=0.98%, Sharpe=3.562
  // holdout 2025-12..2026-06:  net=1114.38636, closed=454, forced=6, win=39.87%, exp=2.454596, PF=1.147, DD=2.94%, Sharpe=1.054
  val s2_optimized_v10 = TestStrategy(
    indicator = Indicator.compositeAnyOf(
      Indicator.LinesCrossing(
        source = ValueSource.HLC3,
        line1Transformation = ValueTransformation.JMA(length = 14, phase = 24, power = 2),
        line2Transformation = ValueTransformation.JMA(length = 24, phase = -5, power = 1)
      ),
      Indicator.ThresholdCrossing(
        source = ValueSource.Close,
  ...
  // GA-optimized indicator params for s2_optimized_v4 (rules unchanged). Champion from ga-optimisation-2026-09-05-2214-s2_optimized_v4_shuffle.md (training 0.601595 -> validation 0.196901, retaining 32.7%), shuffled GA.
  // BREACHES 3 constraint(s) on validation data:
  //   - profitable pair-months is 0.500, required >= 0.550
  //   - most concentrated pair's best month is 0.997, required <= 0.738 (0.700 scaled to 5 periods)
  //   - profit factor is 1.18655, required >= 1.2
  // searched 2023-07..2025-07: net=9606.58981, closed=1543, forced=12, win=39.60%, exp=6.225917, PF=1.427, DD=0.78%, Sharpe=2.526
  // holdout 2025-12..2026-06:  net=1825.77382, closed=459, forced=6, win=41.83%, exp=3.977721, PF=1.255, DD=1.73%, Sharpe=1.613
  val s2_optimized_v11 = TestStrategy(
    indicator = Indicator.compositeAnyOf(
      Indicator.LinesCrossing(
        source = ValueSource.HLC3,
        line1Transformation = ValueTransformation.JMA(length = 14, phase = 30, power = 2),
        line2Transformation = ValueTransformation.JMA(length = 27, phase = 1, power = 1)
      ),
      Indicator.ThresholdCrossing(
        source = ValueSource.Close,
        transformation = ValueTransformation.RSX(length = 29),
  ...
  // GA-optimized indicator params for s2_optimized_v4 (rules unchanged). Training fitness leader from ga-optimisation-2026-09-05-2214-s2_optimized_v4_shuffle.md (training 1.167234 -> validation 0.000000, retaining 0.0%), shuffled GA.
  // BREACHES 3 constraint(s) on validation data:
  //   - profitable pair-months is 0.500, required >= 0.550
  //   - most concentrated pair's best month is 0.997, required <= 0.738 (0.700 scaled to 5 periods)
  //   - profit factor is 1.18655, required >= 1.2
  // searched 2023-07..2025-07: net=12488.28114, closed=1716, forced=12, win=40.68%, exp=7.277553, PF=1.562, DD=1.00%, Sharpe=3.662
  // holdout 2025-12..2026-06:  net=2387.39935, closed=458, forced=6, win=39.52%, exp=5.212662, PF=1.338, DD=1.03%, Sharpe=3.039
  val s2_optimized_v12 = TestStrategy(
    indicator = Indicator.compositeAnyOf(
      Indicator.LinesCrossing(
        source = ValueSource.HLC3,
        line1Transformation = ValueTransformation.JMA(length = 14, phase = 22, power = 2),
  ...
  // GA-optimized indicator params for s2_optimized (rules unchanged). Champion from ga-optimisation-2026-09-05-2303-s2_optimized.md (training 0.836444 -> validation 0.105242, retaining 12.6%).
  // BREACHES 3 constraint(s) on validation data:
  //   - profitable pair-months is 0.467, required >= 0.550
  //   - most concentrated pair's best month is 1.000, required <= 0.738 (0.700 scaled to 5 periods)
  //   - profit factor is 1.13061, required >= 1.2
  // searched 2023-07..2025-07: net=10654.61336, closed=1565, forced=12, win=41.41%, exp=6.808060, PF=1.483, DD=0.90%, Sharpe=3.138
  // holdout 2025-12..2026-06:  net=2244.28303, closed=442, forced=6, win=41.63%, exp=5.077563, PF=1.328, DD=1.37%, Sharpe=2.437
  val s2_optimized_v13 = TestStrategy(
    indicator = Indicator.compositeAnyOf(
      Indicator.LinesCrossing(
        source = ValueSource.HLC3,
        line1Transformation = ValueTransformation.JMA(length = 18, phase = 21, power = 2),
        line2Transformation = ValueTransformation.JMA(length = 30, phase = -75, power = 2)
      ),
      Indicator.ThresholdCrossing(
        source = ValueSource.Close,
        transformation = ValueTransformation.RSX(length = 29),
  ...
  // GA-optimized indicator params for s2_optimized (rules unchanged). Training fitness leader from ga-optimisation-2026-09-05-2303-s2_optimized.md (training 1.120674 -> validation 0.002806, retaining 0.3%).
  // BREACHES 3 constraint(s) on validation data:
  //   - profitable pair-months is 0.467, required >= 0.550
  //   - most concentrated pair's best month is 1.000, required <= 0.738 (0.700 scaled to 5 periods)
  //   - profit factor is 1.13061, required >= 1.2
  // searched 2023-07..2025-07: net=11045.74726, closed=1717, forced=12, win=40.54%, exp=6.433167, PF=1.472, DD=1.04%, Sharpe=3.306
  // holdout 2025-12..2026-06:  net=2176.27720, closed=480, forced=6, win=40.63%, exp=4.533911, PF=1.299, DD=1.31%, Sharpe=2.700
  val s2_optimized_v14 = TestStrategy(
    indicator = Indicator.compositeAnyOf(
      Indicator.LinesCrossing(
        source = ValueSource.HLC3,
        line1Transformation = ValueTransformation.JMA(length = 18, phase = 21, power = 2),
        line2Transformation = ValueTransformation.JMA(length = 32, phase = -37, power = 2)
      ),
      Indicator.ThresholdCrossing(
        source = ValueSource.Close,
        transformation = ValueTransformation.RSX(length = 29),
  ...
  // GA-optimized indicator params for s2_optimized (rules unchanged). Champion from ga-optimisation-2026-09-05-2351-s2_optimized_shuffle.md (training 0.577028 -> validation 0.438617, retaining 76.0%), shuffled GA.
  // BREACHES 2 constraint(s) on validation data:
  //   - profitable pair-months is 0.500, required >= 0.550
  //   - most concentrated pair's best month is 0.813, required <= 0.738 (0.700 scaled to 5 periods)
  // searched 2023-07..2025-07: net=8629.53634, closed=1559, forced=12, win=39.00%, exp=5.535302, PF=1.384, DD=0.74%, Sharpe=2.702
  // holdout 2025-12..2026-06:  net=2191.79951, closed=445, forced=6, win=41.35%, exp=4.925392, PF=1.307, DD=1.33%, Sharpe=3.024
  val s2_optimized_v15 = TestStrategy(
    indicator = Indicator.compositeAnyOf(
      Indicator.LinesCrossing(
        source = ValueSource.HLC3,
        line1Transformation = ValueTransformation.JMA(length = 14, phase = 33, power = 2),
        line2Transformation = ValueTransformation.JMA(length = 26, phase = -1, power = 1)
      ),
      Indicator.ThresholdCrossing(
        source = ValueSource.Close,
        transformation = ValueTransformation.RSX(length = 29),
  ...
  // GA-optimized indicator params for s2_optimized (rules unchanged). Training fitness leader from ga-optimisation-2026-09-05-2351-s2_optimized_shuffle.md (training 1.145664 -> validation 0.002045, retaining 0.2%), shuffled GA.
  // BREACHES 2 constraint(s) on validation data:
  //   - profitable pair-months is 0.500, required >= 0.550
  //   - most concentrated pair's best month is 0.813, required <= 0.738 (0.700 scaled to 5 periods)
  // searched 2023-07..2025-07: net=12283.35278, closed=1558, forced=12, win=39.92%, exp=7.884052, PF=1.569, DD=1.02%, Sharpe=3.333
  // holdout 2025-12..2026-06:  net=2289.29319, closed=426, forced=6, win=39.91%, exp=5.373928, PF=1.334, DD=1.25%, Sharpe=2.144
  val s2_optimized_v16 = TestStrategy(
    indicator = Indicator.compositeAnyOf(
      Indicator.LinesCrossing(
        source = ValueSource.HLC3,
        line1Transformation = ValueTransformation.JMA(length = 14, phase = 20, power = 2),
        line2Transformation = ValueTransformation.JMA(length = 26, phase = -1, power = 1)
      ),
      Indicator.ThresholdCrossing(
        source = ValueSource.Close,
  ...
  // GA-optimized indicator params for s5_optimized_v2 (rules unchanged). Champion from ga-optimisation-2026-09-06-0040-s5_optimized_v2.md (training 0.492804 -> validation 0.277426, retaining 56.3%).
  // BREACHES 2 constraint(s) on validation data:
  //   - most concentrated pair's best month is 1.000, required <= 0.738 (0.700 scaled to 5 periods)
  //   - profit factor is 1.18658, required >= 1.2
  // searched 2023-07..2025-07: net=5138.39940, closed=714, forced=6, win=66.39%, exp=7.196638, PF=1.578, DD=0.41%, Sharpe=2.870
  // holdout 2025-12..2026-06:  net=129.71926, closed=201, forced=0, win=61.69%, exp=0.645369, PF=1.040, DD=1.18%, Sharpe=0.235
  val s5_optimized_v4 = TestStrategy(
    indicator = Indicator.compositeAnyOf(
      Indicator.TrendChangeDetection(
        source = ValueSource.HLC3,
        transformation = ValueTransformation.JMA(length = 57, phase = -3, power = 1)
      ),
      Indicator.BollingerBands(
        source = ValueSource.Close,
        middleBand = ValueTransformation.SMA(length = 35),
  ...
  // GA-optimized indicator params for s5_optimized_v2 (rules unchanged). Training fitness leader from ga-optimisation-2026-09-06-0040-s5_optimized_v2.md (training 1.026425 -> validation 0.000000, retaining 0.0%).
  // BREACHES 2 constraint(s) on validation data:
  //   - most concentrated pair's best month is 1.000, required <= 0.738 (0.700 scaled to 5 periods)
  //   - profit factor is 1.18658, required >= 1.2
  // searched 2023-07..2025-07: net=7124.12084, closed=784, forced=5, win=67.22%, exp=9.086889, PF=1.789, DD=0.42%, Sharpe=3.267
  // holdout 2025-12..2026-06:  net=402.22630, closed=235, forced=0, win=62.13%, exp=1.711601, PF=1.115, DD=0.96%, Sharpe=0.805
  ...
  // GA-optimized indicator params for s5_optimized_v2 (rules unchanged). Champion from ga-optimisation-2026-09-06-0219-s5_optimized_v2_shuffle.md (training 0.701573 -> validation 0.139010, retaining 19.8%), shuffled GA.
  // BREACHES 4 constraint(s) on validation data:
  //   - profitable pair-months is 0.538, required >= 0.550
  //   - most concentrated pair's best month is 1.000, required <= 0.738 (0.700 scaled to 5 periods)
  //   - profit factor is 1.17852, required >= 1.2
  //   - profitable datasets is 0.500, required >= 0.667
  // searched 2023-07..2025-07: net=5161.02510, closed=734, forced=4, win=64.58%, exp=7.031369, PF=1.625, DD=0.47%, Sharpe=3.089
  // holdout 2025-12..2026-06:  net=933.55569, closed=213, forced=0, win=62.91%, exp=4.382891, PF=1.361, DD=1.13%, Sharpe=1.678
  val s5_optimized_v6 = TestStrategy(
    indicator = Indicator.compositeAnyOf(
      Indicator.TrendChangeDetection(
        source = ValueSource.HLC3,
        transformation = ValueTransformation.JMA(length = 60, phase = 20, power = 1)
      ),
      Indicator.BollingerBands(
        source = ValueSource.Close,
  ...
  // GA-optimized indicator params for s1_v2_optimized (rules unchanged). Champion from ga-optimisation-2026-09-06-0400-s1_v2_optimized.md (training 0.307299 -> validation 0.079388, retaining 25.8%).
  // BREACHES 4 constraint(s) on validation data:
  //   - profitable pair-months is 0.467, required >= 0.550
  //   - most concentrated pair's best month is 1.000, required <= 0.738 (0.700 scaled to 5 periods)
  //   - profit factor is 1.10357, required >= 1.2
  //   - profitable datasets is 0.500, required >= 0.667
  // searched 2023-07..2025-07: net=4067.73689, closed=1302, forced=9, win=47.31%, exp=3.124222, PF=1.169, DD=2.00%, Sharpe=1.116
  // holdout 2025-12..2026-06:  net=865.16671, closed=389, forced=6, win=47.04%, exp=2.224079, PF=1.126, DD=1.17%, Sharpe=1.125
  val s1_v2_optimized_v2 = TestStrategy(
    indicator = Indicator.compositeAnyOf(
      Indicator.LinesCrossing(
        source = ValueSource.HLC3,
        line1Transformation = ValueTransformation.JMA(length = 19, phase = -1, power = 3),
        line2Transformation = ValueTransformation.JMA(length = 42, phase = 1, power = 3)
      ),
      Indicator.ThresholdCrossing(
        source = ValueSource.Close,
  ...
  // GA-optimized indicator params for s1_v2_optimized (rules unchanged). Training fitness leader from ga-optimisation-2026-09-06-0400-s1_v2_optimized.md (training 0.552562 -> validation 0.000000, retaining 0.0%).
  // BREACHES 4 constraint(s) on validation data:
  //   - profitable pair-months is 0.467, required >= 0.550
  //   - most concentrated pair's best month is 1.000, required <= 0.738 (0.700 scaled to 5 periods)
  //   - profit factor is 1.10357, required >= 1.2
  //   - profitable datasets is 0.500, required >= 0.667
  // searched 2023-07..2025-07: net=5903.93848, closed=1283, forced=10, win=47.39%, exp=4.601667, PF=1.246, DD=2.37%, Sharpe=1.490
  // holdout 2025-12..2026-06:  net=-222.68603, closed=364, forced=5, win=42.58%, exp=-0.611775, PF=0.970, DD=2.19%, Sharpe=-0.185
  ...
  // GA-optimized indicator params for s1_v2_optimized (rules unchanged). Best by validation from ga-optimisation-2026-09-06-0908-s1_v2_optimized_shuffle.md (training 0.542559 -> validation 0.000000, retaining 0.0%), shuffled GA.
  // NOTHING SELECTED: no finalist scored above zero on validation data.
  // searched 2023-07..2025-07: net=6077.23885, closed=1294, forced=10, win=45.90%, exp=4.696475, PF=1.257, DD=2.59%, Sharpe=1.417
  // holdout 2025-12..2026-06:  net=-27.45298, closed=363, forced=5, win=42.42%, exp=-0.075628, PF=0.996, DD=2.41%, Sharpe=-0.018
  val s1_v2_optimized_v4 = TestStrategy(
    indicator = Indicator.compositeAnyOf(
      Indicator.LinesCrossing(
        source = ValueSource.HLC3,
        line1Transformation = ValueTransformation.JMA(length = 20, phase = 60, power = 3),
        line2Transformation = ValueTransformation.JMA(length = 49, phase = -3, power = 4)
      ),
      Indicator.ThresholdCrossing(
        source = ValueSource.Close,
        transformation = ValueTransformation.RSX(length = 25),
      ...
      Indicator.VolatilityRegimeDetection(
        atrLength = 28,
        smoothingType = ValueTransformation.SMA(length = 43)
      )
    ),
    rules = TradeStrategy(
      openRules = List(
  ...
  // GA-optimized indicator params for s5_optimized_v3 (rules unchanged). Champion from ga-optimisation-2026-09-06-1438-s5_optimized_v3.md (training 0.968883 -> validation 0.284348, retaining 29.3%).
  // BREACHES 2 constraint(s) on validation data:
  //   - profitable pair-months is 0.538, required >= 0.550
  //   - most concentrated pair's best month is 1.000, required <= 0.738 (0.700 scaled to 5 periods)
  // searched 2023-07..2025-07: net=6716.21476, closed=752, forced=6, win=68.09%, exp=8.931137, PF=1.857, DD=0.39%, Sharpe=4.504
  // holdout 2025-12..2026-06:  net=908.79485, closed=228, forced=0, win=64.91%, exp=3.985942, PF=1.306, DD=0.54%, Sharpe=3.196
  val s5_optimized_v8 = TestStrategy(
    indicator = Indicator.compositeAnyOf(
      Indicator.TrendChangeDetection(
        source = ValueSource.HLC3,
        transformation = ValueTransformation.JMA(length = 60, phase = 29, power = 1)
      ),
      Indicator.BollingerBands(
        source = ValueSource.Close,
        middleBand = ValueTransformation.SMA(length = 34),
  ...
  // GA-optimized indicator params for s5_optimized_v3 (rules unchanged). Training fitness leader from ga-optimisation-2026-09-06-1438-s5_optimized_v3.md (training 1.128736 -> validation 0.000000, retaining 0.0%).
  // BREACHES 2 constraint(s) on validation data:
  //   - profitable pair-months is 0.538, required >= 0.550
  //   - most concentrated pair's best month is 1.000, required <= 0.738 (0.700 scaled to 5 periods)
  // searched 2023-07..2025-07: net=8314.47112, closed=768, forced=5, win=68.49%, exp=10.826134, PF=2.094, DD=0.34%, Sharpe=5.155
