...
class FiltersSpec extends AnyWordSpec with Matchers {
  ...
  "A Filters" should {
    ...
    "use kalman filter for removing noise from measurements" in {
      ...
      result mustBe List(55.0094967026825, 54.513152000153546, 53.960265894839225, 53.3854609036031, 52.87666588945132, 52.54188257632462, 52.12559536215797, 51.59852146088533, 50.96648359386705, 50.45)
    }
  }
}
